...
**Authored: `foundations` · `identity` · `compute` · `storage` · `networking` (48 — the whole shippable prefix) + `databases` (9) = 57 sections. Courses 7-11 are declared with `sections: []`.**
