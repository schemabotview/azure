...
**Authored: `foundations` · `identity` · `compute` · `storage` · `networking` (48 — the whole shippable prefix) + `databases` (9) + `serverless` (9) = 66 sections. Courses 8-11 are declared with `sections: []`.**
